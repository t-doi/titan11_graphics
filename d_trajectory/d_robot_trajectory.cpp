...
void RTSetTrajectoryICCRAWL(void)
{
	...
	double move1[]={-500,-500,0};//ì∑ëÃêÑêiéûÇÃÉxÉNÉgÉã1Åiì∑ëÃÇ©ÇÁÇ›ÇΩãrêÊÇÃìÆÇ´Åj
	double move2[]={-500,500,0};//ì∑ëÃêÑêiéûÇÃÉxÉNÉgÉã2Åiì∑ëÃÇ©ÇÁÇ›ÇΩãrêÊÇÃìÆÇ´Åj
	double height=800;//ë´Çâ∫Ç…â∫Ç∞ÇÈó 
	double swing_height=500;//óVãrçÇÇ≥
	double x0=2200;//ãrÇPÇÃãOìπÉxÅ[ÉXì_ÅDÇŸÇ©ÇÃãrÇÕÇ±Ç±Ç…ëŒÇµÇƒëŒèÃ
